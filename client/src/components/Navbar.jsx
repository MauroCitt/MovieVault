...
function NavbarHome({ user, loggedIn }) {
                    ...
                    <div class="flex items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:flex sm:items-center lg:items-center absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                            <div class="flex flex-row space-x-4 justify-center items-center">
                                ...
                                <Link to="/profileList" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm sm:text-base lg:text-lg font-medium no-underline font-saira">Your watchlist</Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative ml-3">
                            <div>
                                {loggedIn ? (
                                    ...
                                    <Link to="/login" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm sm:text-base lg:text-lg font-medium no-underline font-saira">Log In</Link>
                                )}
                            </div>
                            {isDropdownOpen && (
