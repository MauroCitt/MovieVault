                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <Link to={"/home"} class="flex-shrink-0 flex items-center">
                            <div class="flex flex-shrink-0 items-center">
                                <img class="h-25 w-25" src="logoBlanco.png" alt="logo" />
                            </div>
                        </Link>
                        <div class="hidden sm:flex sm:items-center">
                            <div class="flex space-x-4">
                                <Link to="/home" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium no-underline">Home</Link>
                                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium no-underline">Genres</a>
                                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium no-underline">Your watchlist</a>
                            </div>
                        </div>
                    </div>
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <div class="relative ml-3">
                            ...
                            <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none disp" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex="-1">
                                <Link to="/profile" class="block px-4 py-2 text-sm text-gray-700 no-underline" role="menuitem" tabIndex="-1" id="user-menu-item-0" >Your Profile</Link>
                                <a href="#" class="block px-4 py-2 text-sm text-gray-700  no-underline" role="menuitem" tabIndex="-1" id="user-menu-item-2 no-underline">Sign out</a>
                            </div>
                            )}
                        </div>
                    </div>
